...
function createRequest() {
    ...
    Post('https://localhost:7172/Basket/Create', data, (data) => {
...
function categoryChange() {
    ...
    Post('https://localhost:7172/Product/GetCategory', categoryId, (data) => {
        products = data.data;
...
function getAllCategories() {
    Get('https://localhost:7172/Category/GetAllCategory', (data) => {
